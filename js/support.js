...
const SUPPORT_FAQ = {
  en: [
    ...
    { q: 'Are prices final?', a: 'Yes! All prices shown are the final selling price. Gift boxes are full price.' },
  ...
  ta: [
    ...
    { q: 'விலை இறுதியானதா?', a: 'ஆம்! காட்டப்படும் விலைகள் இறுதி விற்பனை விலை. கிஃப்ட் பாக்ஸில் தள்ளுபடி இல்லை.' },
